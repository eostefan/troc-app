...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/hackerman/Desktop/code/graveyard/troc-app/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/hackerman/Desktop/code/graveyard/troc-app/public/storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','generated::8H7h8EfiTFEuEsVJ','generated::HCAjZOCwLdEx7pjr','items.index','items.show',
'login','login.store','logout','register','register.store',
'profile.items.restore','profile.items.index','profile.items.create','profile.items.store','profile.items.show',
'profile.items.edit','profile.items.update','profile.items.destroy','storage.local',);
