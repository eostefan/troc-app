...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\troc-app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\troc-app\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','cloudinary.notification_url','cloudinary.cloud_url',
'cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','inertia.ssr.enabled','inertia.ssr.url',
...
'debugbar.queries.explain','items.index','items.show',
'login','login.store','logout','register','register.store',
'items.offer.store','profile.items.restore','profile.items.index','profile.items.create','profile.items.store',
'profile.items.show','profile.items.edit','profile.items.destroy','profile.items.update','profile.offer.accept',
'profile.photos.destroy','storage.local',);
...
'DB_PASSWORD','CLOUDINARY_URL','CLOUDINARY_CLOUD_NAME','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET',
'CLOUDINARY_SECURE_URL','ASSET_URL','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
